...
export function registerTeamMemberCommands(program: Command) {
    ...
    teamMember.command('edit <teamMemberId>')
        ...
        .option('--model <model>', 'Update model (e.g. sonnet, claude-opus-4-8, claude-opus-4-8[1m], claude-opus-4-7[1m], gpt-5.5, hermes-default)')
    ...
    teamMember.command('create <name>')
        ...
        .option('--model <model>', 'Model to use (e.g. sonnet, claude-opus-4-8, claude-opus-4-8[1m], claude-opus-4-7[1m], gpt-5.5, hermes-default, or native model names)')
