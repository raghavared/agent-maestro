 ...
 *
 * Plus strategy variants (tree/recruit/batching/dag).
 */

// ── Shared building blocks ──────────────────────────────────

const REFERENCE_TASKS_INSTRUCTION =
...
const SIBLING_COMMUNICATION_INSTRUCTION =
...
// ═══════════════════════════════════════════════════════════════
// COORDINATED-WORKER MODE — Worker spawned by a coordinator
// ═══════════════════════════════════════════════════════════════

export const COORDINATED_WORKER_INIT_PHASE =
  'Read your assigned tasks in the <tasks> block.\n' +
  REFERENCE_TASKS_INSTRUCTION + '\n' +
  'If a <coordinator_directive> is present, read it carefully — it contains your coordinator\'s specific instructions.';

export const COORDINATED_WORKER_EXECUTE_PHASE =
  'Work through each task directly — do not decompose or delegate.\n' +
  'IMPORTANT: Print clear status text throughout your work.\n' +
  'After completing each task, report it:\n' +
  '  maestro task report complete <taskId> "<summary of what was done>"\n' +
  ...
  'If blocked, report it:\n' +
  '  maestro task report blocked <taskId> "<what you need>"\n' +
  COORDINATOR_REPORTING_INSTRUCTION + '\n' +
  SIBLING_COMMUNICATION_INSTRUCTION;

export const COORDINATED_WORKER_COMPLETE_PHASE =
  'When all tasks are done:\n' +
  'Before closing, ensure you have added all important work artifacts as task docs:\n' +
  '  maestro task docs add <taskId> "<title>" --file <filePath>\n' +
  '  maestro session report complete "<summary of all work completed>"\n' +
  'Notify your coordinator:\n' +
  '  maestro session prompt <coordinatorSessionId> --message "All tasks done. Session closing."';

// ═══════════════════════════════════════════════════════════════
// COORDINATOR MODE — Standalone coordinator (no parent)
// ═══════════════════════════════════════════════════════════════

export const COORDINATOR_ANALYZE_PHASE =
...
export const COORDINATOR_DECOMPOSE_PHASE =
...
export const COORDINATOR_SPAWN_PHASE =
...
export const COORDINATOR_MONITOR_PHASE =
...
export const COORDINATOR_RECOVER_PHASE =
...
export const COORDINATOR_VERIFY_PHASE =
...
export const COORDINATOR_COMPLETE_PHASE =
  'When all subtasks are done:\n' +
  '  maestro task report complete <parentTaskId> "<summary>"\n' +
  '  maestro session report complete "<overall summary>"';

// ═══════════════════════════════════════════════════════════════
// COORDINATED-COORDINATOR MODE — Sub-coordinator spawned by parent
// ═══════════════════════════════════════════════════════════════

export const COORDINATED_COORDINATOR_ANALYZE_PHASE =
  'Read all assigned tasks in the <tasks> block. Understand the requirements and acceptance criteria. ' +
  'If a <coordinator_directive> is present, read it carefully — it contains your parent coordinator\'s specific instructions.\n' +
  'IMPORTANT: Also inventory the <available_team_members> block in your system prompt if present — note each member\'s ID, name, role, and capabilities.\n' +
  REFERENCE_TASKS_INSTRUCTION + '\n' +
  'You must decompose and delegate — do NOT do them yourself.';

// Decompose, spawn, monitor, recover, verify are shared with standalone coordinator
// (they use the same COORDINATOR_* constants)

export const COORDINATED_COORDINATOR_COMPLETE_PHASE =
  'When all subtasks are done:\n' +
  '  maestro task report complete <parentTaskId> "<summary>"\n' +
  '  maestro session report complete "<overall summary>"\n' +
  'Notify your parent coordinator:\n' +
  '  maestro session prompt <coordinatorSessionId> --message "All subtasks done. <summary>"';
...
/** @deprecated Use COORDINATED_WORKER_INIT_PHASE */
export const EXECUTE_INIT_PHASE = COORDINATED_WORKER_INIT_PHASE;

/** @deprecated Use COORDINATED_WORKER_EXECUTE_PHASE */
export const EXECUTE_WORK_PHASE = COORDINATED_WORKER_EXECUTE_PHASE;

/** @deprecated Use COORDINATED_WORKER_COMPLETE_PHASE */
export const EXECUTE_COMPLETE_PHASE = COORDINATED_WORKER_COMPLETE_PHASE;

/** @deprecated Use COORDINATOR_ANALYZE_PHASE */
export const COORDINATE_ANALYZE_PHASE = COORDINATOR_ANALYZE_PHASE;

/** @deprecated Use COORDINATOR_DECOMPOSE_PHASE */
export const COORDINATE_DECOMPOSE_PHASE = COORDINATOR_DECOMPOSE_PHASE;

/** @deprecated Use COORDINATOR_SPAWN_PHASE */
export const COORDINATE_SPAWN_PHASE = COORDINATOR_SPAWN_PHASE;

/** @deprecated Use COORDINATOR_MONITOR_PHASE */
export const COORDINATE_MONITOR_PHASE = COORDINATOR_MONITOR_PHASE;

/** @deprecated Use COORDINATOR_RECOVER_PHASE */
export const COORDINATE_RECOVER_PHASE = COORDINATOR_RECOVER_PHASE;

/** @deprecated Use COORDINATOR_VERIFY_PHASE */
export const COORDINATE_VERIFY_PHASE = COORDINATOR_VERIFY_PHASE;

/** @deprecated Use COORDINATOR_COMPLETE_PHASE */
export const COORDINATE_COMPLETE_PHASE = COORDINATOR_COMPLETE_PHASE;

/** @deprecated internal building block */
export const COORDINATE_WORK_PHASE = COORDINATOR_REPORTING_INSTRUCTION + '\n' + SIBLING_COMMUNICATION_INSTRUCTION;


// ═══════════════════════════════════════════════════════════════
// WORKER MODE — Tree Strategy
// ═══════════════════════════════════════════════════════════════
...
export const EXECUTE_RECRUIT_WORK_PHASE =
  ...
  '  maestro team-member create "<name>" --role "<role>" --avatar "<emoji>" --mode <worker|coordinator> [--model <model>] [--agent-tool <tool>] [--identity "<instructions>"] [--skills <skill1,skill2,...>]\n\n' +
...
// ═══════════════════════════════════════════════════════════════
// COORDINATOR MODE — Batching Strategy
// ═══════════════════════════════════════════════════════════════
